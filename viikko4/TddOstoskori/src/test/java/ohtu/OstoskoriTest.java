...
public class OstoskoriTest {
    ...
    //step 12
    @Test
    public void kahdenSamanTuotteenLisaamisenJalkeenKorinOstoksellaSamaNimiKuinTuotteellaJaKaksiKappaletta() {
        Tuote maito = new Tuote("maito", 3);
        kori.lisaaTuote(maito);
        kori.lisaaTuote(maito);
        assertEquals("maito", kori.ostokset().get(0).tuotteenNimi());
    ...
    //step 13
    @Test
    public void kahdenSamanTuotteenKoriinJaaYksiTuoteYhdenPoistonJalkeen() {
        Tuote maito = new Tuote("maito", 3);
        kori.lisaaTuote(maito);
        kori.lisaaTuote(maito);
        kori.poista(maito);
    ...
    //step 14
    @Test
    public void josKoriinLisattyTuoteJaSamaTuotePoistetaanKoriOnTyhja() {
        Tuote maito = new Tuote("maito", 3);
        kori.lisaaTuote(maito);
        kori.poista(maito);
        assertEquals(0, kori.tavaroitaKorissa());
    ...
    //step 15
    @Test
    public void tyhjennaMetodiTyhjentaaKorin() {
        Tuote maito = new Tuote("maito", 3);
        kori.lisaaTuote(maito);
        kori.tyhjenna();
        assertEquals(0, kori.ostokset().size());
